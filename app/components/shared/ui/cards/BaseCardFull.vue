...
const buttonClasses = computed(() => {
  ...
  const variantClasses = {
    ...
    outline: 'bg-white text-blue-500 border border-[#1364B3] hover:bg-[#1364B3] hover:text-white',
...
<!--        <h3 class="text-lg font-semibold leading-tight tracking-tight text-blue-500">-->
<!--          {{ title }}-->
<!--        </h3>-->
<!--      </div>-->
...
<!--    </div>-->
    ...
    >
      ...
      <!-- Title -->
      <div class="w-full">
        <h3 class="mb-3 text-lg font-semibold leading-tight tracking-tight text-blue-500">
          {{ title }}
        </h3>
      </div>
    ...
    <div v-else-if="type === 'review'" class="flex h-full w-full flex-col items-start">
      ...
      <!-- Reviewer Name -->
      <div class="w-full">
        <p class="text-sm font-bold text-blue-500">{{ reviewerName }}</p>
      </div>
    </div>
