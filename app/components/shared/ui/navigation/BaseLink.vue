...
const linkClasses = computed(() => {
  const baseClasses = [
    'inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-[0.8px]',
    props.disabled ? 'opacity-50 cursor-not-allowed pointer-events-none' : 'cursor-pointer',
  ];

  // Clases por variante
  const variantClasses = {
    blue: 'rounded-xl px-6 py-3 bg-[#1364B3] text-white hover:bg-[#0f4d8a] focus:ring-[#1364B3]',
    'blue-600': 'rounded-xl px-6 py-3 bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-600',
    'blue-outline':
      'rounded-xl px-6 py-3 bg-white text-[#1364B3] border border-[#1364B3] hover:bg-[#1364B3] hover:text-white focus:ring-[#1364B3]',
    ...
    'white-outline':
      'rounded-xl px-6 py-3 bg-white text-black border border-black hover:bg-black hover:text-white focus:ring-gray-800',
    'green-500':
      'rounded-xl px-6 py-3 bg-green-500 text-white hover:bg-green-600 focus:ring-green-500',
    'green-600':
      'rounded-xl px-6 py-3 bg-green-600 text-white hover:bg-green-700 focus:ring-green-600',
    circular:
